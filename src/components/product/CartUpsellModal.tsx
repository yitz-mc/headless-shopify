...
import type { UpsellVariant } from '@/types';
...
export function CartUpsellModal({
  ...
  return (
    <>
      {/* Overlay */}
      <div className='fixed inset-0 bg-black/70 z-[9999]' onClick={handleNoThanks} />
      ...
      <div className='fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] max-w-[90%] bg-white rounded-[15px] p-[30px] z-[10000]'>
        ...
        <div className='flex flex-col items-center gap-2.5 text-center'>
          ...
          <p className='text-base m-0'>Great choice! Make this tower even better:</p>
        </div>
        ...
        <div className='flex gap-[30px] justify-center items-center my-6 max-[450px]:gap-4 max-[450px]:my-5'>
          ...
          {/* Info */}
          <div className='flex-1'>
            <p className='text-base font-medium m-0'>{upsellVariant.product.title}</p>
            <p className='text-xs m-0 opacity-100 leading-normal'>{upsellVariant.title}</p>
